  ...
  return (
   <div className='p-6 max-w-7xl mx-auto'>
      <div className="space-y-2 mb-6">
        <h1 className="text-3xl font-bold tracking-tight">Update User Account</h1>
        <p className="text-slate-600">
        Update User Account of existing User.
        </p>
      </div>
